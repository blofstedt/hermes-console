...
class _BridgeFileEditorScreenState extends State<BridgeFileEditorScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // Este editor escribe en el servidor con un paso «aplicar» explícito: sin
    // esta guarda, el botón atrás tiraba en silencio todo lo escrito.
    return PopScope(
      canPop: !_editable || !bridgeIsDirty,
